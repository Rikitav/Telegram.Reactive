...
namespace Telegram.Reactive.Hosting.Extensions
{
    /// <summary>
    ...
    public abstract class ConfigureOptionsProxy<TOptions> where TOptions : class
    {
        ...
        {
            var namedConfigure = new NamedConfigureFromConfigurationOptions<ConfigureOptionsProxy<TOptions>>(name, configuration);
